        ...
        <div class="flex h-screen">
            ...
            <div class="w-1/4 bg-gray-100 text-gray-800 flex flex-col items-center p-6 space-y-4">
                ...
                <nav class="flex flex-col w-full space-y-2">
                    <button class="w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Perfil</button>
                    <button class="w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Ajustes</button>
                    <button class="w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Ayuda</button>
            ...
            <div class="w-3/4 p-6">
                ...
                <div class="flex justify-around mb-6">
                    <button class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">Constancia</button>
                    ...
                    <button class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">Contacto</button>
                </div>
        ...
        <div class="bg-gray-800 bg-opacity-25 fixed inset-0 backdrop-blur-sm flex items-center justify-center">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mb-4 ml-4 flex justify-center">
                    ...
                    <x-input for="fecha_inicio" wire:model='fecha_inicio'/>
                    <x-label style="color: black" for="fecha_fin" value='Fecha de finalizacion'/>
                    <x-input for="fecha_fin" wire:model='fecha_fin'/>
