        ...
        <div class="login_contenedor-right">
            ...
            <div class="right_contenedor center-flex">
                ...
                <div class="login-option">
                    <a href="{{ route('estudiante-login') }}" class="activo">Estudiante</a>
                    <a href="{{ route('docente-login') }}">Docente</a>
                    <a href="{{ route('administrativo-login') }}">Administrador</a>
                </div>
                <form wire:submit='loginEstudiante'>
                    <div class="input_contenedor">
                        ...
                        <input type="text" id="expediente" name="expediente" wire:model='expediente'
